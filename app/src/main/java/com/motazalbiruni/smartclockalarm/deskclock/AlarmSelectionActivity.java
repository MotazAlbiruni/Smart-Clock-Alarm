...
import com.chen.deskclock.widget.selector.AlarmSelection;
import com.chen.deskclock.widget.selector.AlarmSelectionAdapter;
...
public class AlarmSelectionActivity extends ListActivity {
    ...
    public static final String EXTRA_ACTION = "com.chen.deskclock.EXTRA_ACTION";
    public static final String EXTRA_ALARMS = "com.chen.deskclock.EXTRA_ALARMS";
